...
$AllTools = @(
    ...
    @{ Category = 'Development Environments'; Name = 'webtop'; Description = 'Linux desktop in browser (no X11)' }
    @{ Category = 'Development Environments'; Name = 'webtopxfce'; Description = 'Webtop with XFCE desktop' }
    @{ Category = 'Development Environments'; Name = 'webtopstart'; Description = 'Start Webtop container' }
    @{ Category = 'Development Environments'; Name = 'webtopstop'; Description = 'Stop Webtop container' }
    @{ Category = 'Development Environments'; Name = 'webtoplogs'; Description = 'View Webtop logs' }
